...
function useTransition(data, props, deps) {
  ...
  const prevContext = react_spring_shared_modern_usePrev(context);
  const hasContext = context !== prevContext && hasProps(context);
  react_spring_shared_modern_useIsomorphicLayoutEffect(() => {
    if (hasContext) {
      react_spring_shared_modern_each(transitions, (t) => {
...
;// CONCATENATED MODULE: ../node_modules/react-spring/dist/react-spring.modern.mjs
// src/index.ts
